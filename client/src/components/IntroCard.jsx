...
const IntroCard = () => {
  return (
    <div className="h-screen p-6 pt-32 bg-white md:p-28">
      <div className="grid grid-cols-1 md:grid-cols-2 h-full gap-6 ">
        <div className="flex flex-col justify-center items-start">
          <div className="pb-2 text-4xl md:text-7xl tracking-widest text-green-900 font-dancing">Sankalp <i className='text-cyan-700'>Adhya</i> </div>
          <div className="pb-2 text-lg font-mono md:text-xl font-semibold text-emerald-800 tracking-tight">Full Stack Developer and Aspiring Software Engineer</div>
          <div className="pb-2 text-base md:text-xl font-normal text-slate-700 leading-loose">
          ...
          <div className='text-black font-semibold font-mono mt-2'>
            ...
            <div className='grid grid-cols-4 w-fit md:grid-cols-4 gap-8 mt-6 items-center justify-center'>
        ...
        <div className="flex justify-center items-center">
          <Lottie animationData={Block} className="w-full" />
        </div>
      </div>
    </div>
  );

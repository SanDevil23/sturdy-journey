  ...
  return (
    <div className='text-white p-6 md:p-20'>
      ...
      <div className='text-center text-lg md:text-2xl font-extralight mt-4'>
        Over the years, I have explored various technologies and frameworks to develop applications ranging from small web pages to enterprise-level applications. With my alignment towards backend development, I have the ability to develop backend on various programming languages.
      </div>
      <div className='grid grid-cols-2 md:grid-cols-5 gap-4 items-center justify-center pt-20'>
